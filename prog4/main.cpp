...
{	
	...
	for(int i=0;i<length;i++){
		for(int j=0;j<length-i-1;j++){
			compares++;
			if(lst[j].calculateGrade()<lst[j+1].calculateGrade())
				swap(lst,j,j+1);
		}
	}
	return compares;
...
{	
	...
	for(int i=0;i<length;i++){
		for(int j=0;j<length-i-1;j++){
			compares++;
			if(lst[j].calculateAdjustedGrade()<lst[j+1].calculateAdjustedGrade())
				swap(lst,j,j+1);
		}
	}
	return compares;
...
int selectionSortByOriginalGrade(Student lst[], int length)
{
	...
	for(int i=0;i<length-1;i++){
		...
		for(int j=i;j<length;j++){
			compares++;
			if(lst[high].calculateGrade()<lst[j].calculateGrade())
				high=j;
		}
		swap(lst,i,high);
	}
...
int selectionSortByAdjustedGrade(Student lst[], int length)
{
	...
	for(int i=0;i<length-1;i++){
		...
		for(int j=i;j<length;j++){
			compares++;
			if(lst[high].calculateAdjustedGrade()<lst[j].calculateAdjustedGrade())
				high=j;
		}
		swap(lst,i,high);
	}
...
int quicksortByOriginalGrade(Student lst[], int first, int last)
{
	...
	for(int i=first;i<pivotIndex;i++){
		compares++;
		if(lst[i].calculateGrade()<lst[pivotIndex].calculateGrade()){
			swap(lst,i,pivotIndex-1);
			swap(lst,pivotIndex-1,pivotIndex);
			pivotIndex--;
			i=first-1;
		}
	}
	compares+=quicksortByOriginalGrade(lst,first,pivotIndex-1);
	compares+=quicksortByOriginalGrade(lst,pivotIndex+1,last);
	return compares;
} /* quick sort by grade */
...
int quicksortByAdjustedGrade(Student lst[], int first, int last)
{
	...
	for(int i=first;i<pivotIndex;i++){
		compares++;
		if(lst[i].calculateAdjustedGrade()<lst[pivotIndex].calculateAdjustedGrade()){
			swap(lst,i,pivotIndex-1);
			swap(lst,pivotIndex-1,pivotIndex);
			pivotIndex--;
			i=first-1;
	...
	compares+=quicksortByAdjustedGrade(lst,first,pivotIndex-1);
	compares+=quicksortByAdjustedGrade(lst,pivotIndex+1,last);
	return compares;
...
int mergeByOriginalGrade(Student lst[], int firstA, int lastA, int lastB)
{
	...
	int j=lastA+1;
	int counter=0;
	Student list[(lastA-firstA+1)+(lastB-lastA)];
...
int mergeSortByOriginalGrade(Student lst[], int first, int last)
{
	...
	compares+=mergeSortByOriginalGrade(lst,first,mid);
	compares+=mergeSortByOriginalGrade(lst,mid+1,last);
	compares+=mergeByOriginalGrade(lst,first,mid,last);
	return compares;
...
int mergeSortByAdjustedGrade(Student lst[], int first, int last)
{
	...
	int mid=(last+first)/2;
	compares+=mergeSortByAdjustedGrade(lst,first,mid);
	compares+=mergeSortByAdjustedGrade(lst,mid+1,last);
	compares+=mergeByAdjustedGrade(lst,first,mid,last);
	return compares;
